module.exports = {
   ...
   $image[https://api.no-api-key.com/api/v2/color?hex=$toLowercase[$replaceText[$message[1];#;;1]]]
    ...
    $onlyIf[$getGlobalUserVar[PREMIUMgeneral;$authorID]!=false;{description:Lo sentimos, este comando es premium, cambie a premium para acceder a comandos exclusivos!}{color:RED}]
