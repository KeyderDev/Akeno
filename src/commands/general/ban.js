module.exports = ({
    name: "ban",
    code: `$ban[$findMember[$message[1]];$noMentionMessage]
    $wait[1s]
    $sendDm[$findMember[$message[1]];{author:▸ 🔨┇Ban} {description::alert: Has sido baneado en el servidor \`$serverName[$guildID]\` por la razón: \`$noMentionMessage\`} {color:D1BBBB} {timestamp:ms}]
